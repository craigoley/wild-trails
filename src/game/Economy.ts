...
// R1 (§4.1.4): the biome nets are no longer SHOP-BOUGHT — they're earned through research
// (study the habitat -> grantTool the net, via the swappable seam). buyNet/netBuyState
// retired; the single acquisition path is research-completion (game/Research + main's reward
// dispatch). The shop keeps bait + equipping owned nets.
